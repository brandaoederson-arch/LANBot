...
const ROLE_ASSIGNMENTS = [
    {
        ...
        getWinner: rankedPlayers => [...rankedPlayers].sort((a, b) => (b.kills || 0) - (a.kills || 0))[0]
    },
    {
    ...
    },
    {
        ...
        getWinner: rankedPlayers => [...rankedPlayers].sort((a, b) => (b.headshotRate || 0) - (a.headshotRate || 0))[0]
    },
    {
        roleId: ids.roles.veterano,
        label: 'Veterano',
        getWinner: rankedPlayers => [...rankedPlayers].sort((a, b) => (b.roundsPlayed || 0) - (a.roundsPlayed || 0))[0]
    },
    {
        roleId: ids.roles.anjoGuarda,
        label: 'Anjo da Guarda',
        getWinner: rankedPlayers => [...rankedPlayers].sort((a, b) => ((b.assists || 0) + (b.revives || 0)) - ((a.assists || 0) + (a.revives || 0)))[0]
    }
];
